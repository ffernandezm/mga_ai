"""Add ProblemTreeJson field

Revision ID: f68bc623c84f
Revises: 
Create Date: 2025-03-30 01:02:03.776580
...
def upgrade() -> None:
    ...
    op.add_column("problems", sa.Column("problem_tree_json", sa.JSON(), nullable=True))
    ...
    op.execute("DROP TABLE IF EXISTS direct_effects CASCADE")
   ...
   # op.drop_index('ix_population_id', table_name='population')
    ...
    op.execute("DROP TABLE problems CASCADE")
