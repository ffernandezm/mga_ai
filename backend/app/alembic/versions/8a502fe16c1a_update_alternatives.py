...
Revision ID: 8a502fe16c1a
Revises: dd570467aabf
Create Date: 2025-10-15 11:17:59.750543
...
revision: str = '8a502fe16c1a'
down_revision: Union[str, None] = 'dd570467aabf'
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('project_id', name='participants_general_project_id_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
