"""update table chat_history 3

Revision ID: 0780a7156026
Revises: 270a6c5dd377
Create Date: 2025-10-09 13:54:15.958993
...
revision: str = '0780a7156026'
down_revision: Union[str, None] = '270a6c5dd377'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('objectives_project_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('objectives_pkey')),
    sa.UniqueConstraint('project_id', name=op.f('objectives_project_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
