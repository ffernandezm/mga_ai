"""update objetives and alternatives tabes

Revision ID: dd570467aabf
Revises: 0780a7156026
Create Date: 2025-10-15 11:09:04.792533
...
revision: str = 'dd570467aabf'
down_revision: Union[str, None] = '0780a7156026'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('population_project_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('population_pkey')),
    sa.UniqueConstraint('project_id', name=op.f('population_project_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name=op.f('problems_project_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('problems_pkey')),
    sa.UniqueConstraint('project_id', name=op.f('problems_project_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
