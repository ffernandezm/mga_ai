"""update Interveniton Population pydantic

Revision ID: 3d5da2cc239c
Revises: 85a57b8aae14
Create Date: 2025-07-29 23:13:44.013801
...
revision: str = '3d5da2cc239c'
down_revision: Union[str, None] = '85a57b8aae14'
...
def upgrade() -> None:
    ...
    # op.drop_index('ix_affected_population_id', table_name='affected_population')
    ...
    # op.drop_index('ix_intervention_population_id', table_name='intervention_population')
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('project_id', name='participants_general_project_id_key'),
    ...
    sa.ForeignKeyConstraint(['participants_general_id'], ['participants_general.id'], name='participants_participants_general_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['population_id'], ['population.id'], name='intervention_population_population_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='intervention_population_pkey')
    )
    op.create_index('ix_intervention_population_id', 'intervention_population', ['id'], unique=False)
    ...
    sa.Column('population_type_intervention', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('source_information_intervention', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('number_intervention', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    sa.UniqueConstraint('project_id', name='population_project_id_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('location_entity', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('population_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['population_id'], ['population.id'], name='affected_population_population_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='affected_population_pkey')
    )
    op.create_index('ix_affected_population_id', 'affected_population', ['id'], unique=False)
