...
Revision ID: 51abcff24ad0
Revises: 
Create Date: 2025-07-24 00:28:12.740533
...
def upgrade() -> None:
    ...
    op.add_column('projects', sa.Column('participants_general_id', sa.INTEGER(), nullable=True))
...
def downgrade() -> None:
    ...
    # ### end Alembic commands ###
    op.drop_column('projects', 'participants_general_id')
