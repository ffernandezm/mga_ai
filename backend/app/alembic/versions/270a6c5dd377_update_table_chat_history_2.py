"""update table chat_history 2

Revision ID: 270a6c5dd377
Revises: 780847883844
Create Date: 2025-10-09 13:20:01.890176
...
revision: str = '270a6c5dd377'
down_revision: Union[str, None] = '780847883844'
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('alternatives_general_pkey'))
    )
