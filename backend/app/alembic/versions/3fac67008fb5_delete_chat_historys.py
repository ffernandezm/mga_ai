"""delete chat_historys

Revision ID: 3fac67008fb5
Revises: 8a502fe16c1a
Create Date: 2025-10-15 11:47:44.311475
...
revision: str = '3fac67008fb5'
down_revision: Union[str, None] = '8a502fe16c1a'
...
def downgrade() -> None:
    ...
    sa.Column('project_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='alternatives_general_project_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='alternatives_general_pkey'),
    sa.UniqueConstraint('project_id', name='alternatives_general_project_id_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
