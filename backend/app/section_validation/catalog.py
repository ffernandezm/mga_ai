...
_CATALOG: Dict[str, List[Dict[str, Any]]] = {
    ...
    "localization": [{"field_key": "localizations", "label_es": "Localización de la alternativa", "field_type": "table", "required": True}, {"field_key": "department", "label_es": "Departamento", "field_type": "select", "required": True}, {"field_key": "city", "label_es": "Municipio o ciudad", "field_type": "text", "required": False}, {"field_key": "coordinates", "label_es": "Coordenadas de la localización", "field_type": "text", "required": True}],
